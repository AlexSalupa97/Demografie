...
public class CalculIndicatoriFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for(int i=1;i<listaVariatieGenerala.size();i++) {
            listaCalculPopulatie.add(new Populatie(an, listaPopulatie.get(i).getValoare(), listaPopulatie.get(i-1).getValoare() + listaVariatieGenerala.get(i), listaVariatieMigratorie.get(i), listaVariatieNaturala.get(i)));
            an++;
        }
