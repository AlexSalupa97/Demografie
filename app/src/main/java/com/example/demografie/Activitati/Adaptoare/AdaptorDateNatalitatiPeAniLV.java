...
public class AdaptorDateNatalitatiPeAniLV extends ArrayAdapter<CSVNatalitatePeAni> {

    public AdaptorDateNatalitatiPeAniLV(Activity context, ArrayList<CSVNatalitatePeAni> lista) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CSVNatalitatePeAni curent = getItem(position);
